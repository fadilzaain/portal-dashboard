...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // ── Db kedua: belanja (transaksi, cheque)
        'mysql2' => [
            'driver'    => 'mysql',
            'host'      => env('DB_HOST2', '192.168.10.28'),
            'port'      => env('DB_PORT2', '3306'),
            'database'  => env('DB_DATABASE2', 'belanja'),
        ...
        'mysql3' => [
            ...
            'database'  => env('DB_DATABASE3', 'sipanda_db'),
        ...
        'erm_rs' => [
            'driver'    => 'mysql',         
            'host'      => env('ERM_RS_DB_HOST', '127.0.0.1'),
            'port'      => env('ERM_RS_DB_PORT', '3306'),
            'database'  => env('ERM_RS_DB_DATABASE', 'erm_rs'),
            'username'  => env('ERM_RS_DB_USERNAME', 'root'),
            'password'  => env('ERM_RS_DB_PASSWORD', ''),
            'unix_socket'   => env('DB_SOCKET', ''),
            'charset'       => 'utf8mb4',
            'collation'     => 'utf8mb4_unicode_ci',
            'prefix'        => '',
        ...
        'klaim_bpjs' => [
            'driver'    => 'mysql',
            'host'      => env('DB_HOST4', '192.168.10.28'),
            'port'      => env('DB_PORT4', '3306'),
            'database'  => env('DB_DATABASE4', '231_vclaim'),

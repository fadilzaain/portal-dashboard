...
<div class="dash-wrap">
    ...
    <div class="filter-bar">
        ...
        {{-- Tombol Home --}}
        <a href="{{ url('/') }}" title="Kembali ke Home" style="
            margin-left: auto;
            ...
            transition: all .15s;
        "
        onmouseover="this.style.background='#1e2438';this.style.color='#e2e8f0'"
        onmouseout="this.style.background='transparent';this.style.color='#7D8590'">
